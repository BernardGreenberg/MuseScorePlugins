...
Here, we will use the MuseScore *staccato* dot, which can be applied to a note by typing Shift-S, as a means of applying "off-time 500" to a note accurately.  That is exactly what it does, as can be verified in the Piano Roll Editor (PRE).
